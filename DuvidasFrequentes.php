       ...
       <div class="clear"></div>
        ...
        <div class="breadcrumb">
        	<ul>
                ...
                <li><a href="#">Lista de Dúvidas</a></li>
            </ul>
            <div class="clear"></div>
        </div>
        <!-- Bread Crumb End -->
        ...
        <div class="pageheading">
        	<div class="textsec">
                <h1 style="color: #1e1e1e"><strong>Dúvidas Frequentes</strong></h1>
                <p class="black">(10 Dúvidas Cadastrada)</p>
            </div>
...
<div id="contentsec">
    <div class="inner">
        ...
        <?php include "ListaDuvidasFrequentes.php"; ?>
